...
enum procstate { UNUSED, EMBRYO, SLEEPING, RUNNABLE, RUNNING, ZOMBIE , NSTATE};
enum class_and_level {WITHOUT_PRIORITY,EARLIEST_DEADLINE_FIRST,MULTILEVEL_FEEDBACK_QUEUE_FIRST_LEVEL,MULTILEVEL_FEEDBACK_QUEUE_SECOND_LEVEL , NCLASS};
